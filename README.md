...
services:
  moontv-core:
    image: ghcr.io/mcgtekwrt/lunatv-armv7:latest
...
2. **添加 LunaTV 服务**
   - 点击 "Add Service" > "Docker Images"
   - 输入镜像名称：`ghcr.io/mcgtekwrt/lunatv-armv7:latest`
   - 配置端口：`3000` (HTTP)
...
[![Star History Chart](https://api.star-history.com/svg?repos=mcgtekwrt/lunatv-armv7&type=Date)](https://www.star-history.com/#mcgtekwrt/lunatv-armv7&Date)
